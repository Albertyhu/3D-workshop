...
const Cube3XCoor = '400px';
const Cube3YCoor = '-120px';
...
const Pyramid3YCoor = '100px';
const Pyramid3ZCoor = '10px';
const Pyramid3YRotate = '90deg';
const Pyramid3ZRotate = '0deg';
const Pyramid3XRotate = '45deg';
const Pyramid3Scale = '1, 1, 1';
